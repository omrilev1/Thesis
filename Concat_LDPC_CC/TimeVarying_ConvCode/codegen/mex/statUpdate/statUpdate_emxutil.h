/*
 * statUpdate_emxutil.h
 *
 * Code generation for function 'statUpdate_emxutil'
 *
 */

#ifndef STATUPDATE_EMXUTIL_H
#define STATUPDATE_EMXUTIL_H
...
extern void emxEnsureCapacity_real_T(const emlrtStack *sp, emxArray_real_T
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation);
extern void emxFreeMatrix_cell_wrap_0(const emlrtStack *sp, cell_wrap_0 pMatrix
  [2]);
...
/* End of code generation (statUpdate_emxutil.h) */
