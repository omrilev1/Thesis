/*
 * statUpdate_emxutil.c
 *
 * Code generation for function 'statUpdate_emxutil'
 *
 */
...
static void emxFreeStruct_cell_wrap_0(const emlrtStack *sp, cell_wrap_0 *pStruct);
...
void emxFreeMatrix_cell_wrap_0(const emlrtStack *sp, cell_wrap_0 pMatrix[2])
{
  int32_T i;
  for (i = 0; i < 2; i++) {
...
/* End of code generation (statUpdate_emxutil.c) */
