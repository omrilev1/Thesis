START_DIR = C:\Users\OmriLev\DOCUME~1\GitHub\Thesis\CONCAT~1\TIMEVA~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2018a
MAKEFILE = statUpdate_mex.mk

include statUpdate_mex.mki
...
MEX_FILE_NAME_WO_EXT = statUpdate_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\statUpdate"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\statUpdate/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\statUpdate/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\statUpdate/%.cu
	$(CC) $(CCFLAGS) "$<"
