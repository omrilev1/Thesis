  function [Estimated_U,Estimated_L] = gRS4_BIMLPCM_SC_Decoder(m,m_BIPCM,Constellation_Mapping_Array,Y,U,X,Sigma,future_matrix,Is_Frozen_Bit_Index_Vec,Is_Genie_Aided,g0)
    ...
    if(m_BIPCM>0)
        ...
        [Estimated_U,~,Estimated_L] = gRS4_SC_Decoder(Estimated_lambda,U,U_N,Is_Frozen_Bit_Index_Vec(1:2:end),Is_Genie_Aided);
    ...
    for i=m_BIPCM+1:2:m
        ...
        [Estimated_U((index-1)*N_gf2+1:index*N_gf2),Estimated_X_temp,Estimated_L(:,(index-1)*N+1:index*N)] = gRS4_SC_Decoder(Estimated_lambda,U((index-1)*N_gf2+1:index*N_gf2),N_gf2,Is_Frozen_Bit_Index_Vec((index-1)*N_gf2+1:2:index*N_gf2),Is_Genie_Aided); 
