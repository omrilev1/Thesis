 function [Estimated_U,Estimated_L] = gArikan_Multi_Dimensional_BIPCM_SCL_Decoder(L,GA_CRC_Length,m,Constellation_Mapping_Array,Y,U,Sigma,future_matrix,Is_Frozen_Bit_Index_Vec,Is_Genie_Aided)
    ...
    [LL0,LL1] = AWGN_Multi_Dimensional_BIPCM_LL(m,Constellation_Mapping_Array,Y,Sigma,future_matrix);
