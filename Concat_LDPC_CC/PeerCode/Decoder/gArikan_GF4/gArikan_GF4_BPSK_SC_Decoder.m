 function [Estimated_U,Estimated_L] = gArikan_GF4_BPSK_SC_Decoder(Y,U,Sigma,Is_Frozen_Bit_Index_Vec,Is_Genie_Aided)
    ...
    [Estimated_U,~,Estimated_L] = gArikan_GF4_SC_Decoder(lambda,U,N,Is_Frozen_Bit_Index_Vec(1:2:end),Is_Genie_Aided);
