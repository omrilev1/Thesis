 function [Estimated_U,Estimated_L] = gArikan_GF4_BIPCM_SC_Decoder(m,Constellation_Mapping_Array,Y,U,Sigma,future_matrix,Is_Frozen_Bit_Index_Vec,Is_Genie_Aided)
    ...
    [Estimated_U,~,Estimated_L] = gArikan_GF4_SC_Decoder(lambda,U,U_N,Is_Frozen_Bit_Index_Vec(1:2:end),Is_Genie_Aided);
