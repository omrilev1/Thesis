  function [Estimated_U,Estimated_L] = gArikan_GF4_BIMLPCM_SC_Decoder_N_m(m,m_BIPCM,Constellation_Mapping_Array,Y,U,X,Sigma,future_matrix,Is_Frozen_Bit_Index_Vec,Is_Genie_Aided,g0)
...
%     Estimated_X = zeros(1,m,N);
    ...
    if(m_BIPCM>0)
        ...
        [Estimated_U,~,Estimated_L] = gArikan_GF4_SC_Decoder(Estimated_lambda,U,U_N,Is_Frozen_Bit_Index_Vec,Is_Genie_Aided);
