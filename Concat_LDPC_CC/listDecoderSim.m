function [Estimated_Bhattacharyya,SER_Vec,Is_Frozen_Bit_Index_Vec,Estimated_Is_Frozen_Bit_Index_Vec,...
    ...
    Simulated_First_Symbol_Vec,Simulated_LLR_Avg_Vec,Simulated_LLR_Var_Vec] = listDecoderSim(NumOfWorkers,Is_Genie_Aided,g,g0,Decode_Type,L,GA_CRC_Length,...
    Constellation_Type,m,m_BIPCM,m_SCL,Constellation_Mapping_Array,N,R,...
    BLER,SNR,Min_Num_Of_Errors_Sufficient_Statistics,Is_Frozen_Bit_Index_Vec)
