function [MSE,power_scale,beta,gamma] = calc_feedback_coeffs(P,Pin,sigma_n,sigma_n_feedback,Nfeedback,p_alias,type)
...
%the MSE
% type is to choose between modulo-based feedback and simple linear scaling
