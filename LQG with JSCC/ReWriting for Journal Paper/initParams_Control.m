...
Params.R = 3;                       % LQG Cost parameters

Params.ratio_up = 1;% 3;                % Control Cost Uncertainity - upper limit
Params.ratio_down = 1;% 1/3;            % Control Cost Uncertainity - upper limit
...
Params.alphaTuncel    = 0.75;% 0.8;             %  Tuncel scheme parameters
Params.betaTuncel     = -1.18;% -1.15;           % Tuncel scheme parameters;
