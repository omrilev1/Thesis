...
% We assume full knowledge of cost coefficients Q,R , but 0 knowledge
% of the target point x_ref 

close all; clear all; clc;

% Init parameters and arrays structures
Params = initParams_Control_TrackingLQG();
...
for i=1:length(Params.SNR)
    ...
    iVec = zeros(Params.NumOfSchemes,1);
    ...
    for n = 1 : Params.N_avg
        for t=1:Params.T
            ...
            elseif t==Params.T
                ...
                % evolution
                xVec = Params.alpha*xVec + curr_w*ones(Params.NumOfSchemes,1) + uVec;
                iVec = iVec + (xVecEstim - Params.xRef) ; 
            end
