...
plot(SNR(idx),10*log10(profile(idx)),'-.','LineWidth',2);hold on;
plot(SNR(idx),10*log10(D_Linear(idx)),'LineWidth',2); hold on;
plot(SNR(idx),10*log10(D_PPM(idx)),'--k','LineWidth',2); hold on;
...
semilogy(SNR(idx),totalEnergy_Linear(idx),'LineWidth',2); hold on;
semilogy(SNR(idx),totalEnergy_PPM(idx),'-.k','LineWidth',2);hold on;
